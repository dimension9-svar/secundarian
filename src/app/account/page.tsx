      ...
      <Container maxWidth="md">
        ...
        {isStaff && (
          <Paper elevation={0} sx={{ p: 2.5, mb: 3, border: "1px solid rgba(196,162,101,0.4)", bgcolor: "rgba(196,162,101,0.08)" }}>
            <Typography sx={{ fontSize: "0.9rem" }}>
              ...
              <Typography component={Link} href="/admin" sx={{ color: "secondary.main", textDecoration: "none", fontWeight: 600 }}>
        ...
        <Paper elevation={0} sx={{ p: { xs: 3, md: 4 }, mb: 3, border: "1px solid rgba(26,26,26,0.08)" }}>
          ...
          <Typography sx={{ color: "text.secondary" }}>
            ...
            <Typography component={Link} href="/shop" sx={{ color: "secondary.main", textDecoration: "none" }}>
              shop
            </Typography>
            .
          </Typography>
